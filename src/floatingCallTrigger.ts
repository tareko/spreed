...
export const ALLOWED_DIRECT_CALL_URL_REGEX = /(\/apps\/spreed\/\?callUser=|\/call\/)([a-zA-Z0-9_. @-].*)(#direct-call)/i
...
document.addEventListener('click', (event) => {
	...
	// ignore non-Talk links and redirect-to-Talk links (without #direct-call)
